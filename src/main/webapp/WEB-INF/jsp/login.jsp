...
<link href="images/5aec64ca61361f0bc8b358ef.jpg" />
 <style type="text/css">
			...
			body{
				...
				background-image: url(http://www.edebiyat.biz/gifler/8.gif);
	...
	<div class="row">
		 ...
		 <div class="col-md-4 offset-md-4">
			    ...
			    <form method="POST" action="${contextPath}/login" class="form-signin">
			        <h2 class="form-heading">GİRİŞ</h2>
			
			        <div class="form-group ${error != null ? 'has-error' : ''}">
			            <span>${message}</span>
			            
			            <input name="username" type="text"     class="form-control" placeholder="Kullanıcı Adı"  autofocus="true"/>
